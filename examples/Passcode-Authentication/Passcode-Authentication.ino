...
//UPDATE: Provide the Root CA details of the Duo API Host
//Below is an example for the format and must be updated
const char* root_ca= \
"-----BEGIN CERTIFICATE-----\n" \
...
void loop(){
	...
	if ((WiFi.status() == WL_CONNECTED)){
		...
		if(readyToAuth){
			...
			duoAuth.begin(duo_host, duo_akey, duo_skey, root_ca, &timeinfo);
