...
public:
	 ...
	 * @param rootCa Contains the Base-64 encoded X.509 CA Certificate for the duoApiHost
	 * @param timeInfo Contains the Memory Pointer to the timeinfo Structure Declaration
	 */
	void begin(const char* duoApiHost, const char* duoApiIKey, const char* duoApiSKey, const char* rootCa, struct tm* timeInfo);
...
protected:
	...
	bool submitApiRequest(enum DUO_HTTP_METHOD apiMethod, char *timeString, const char* apiPath, char *hmacPassword, char* requestContents);
